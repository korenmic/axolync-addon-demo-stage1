...
- `demo_track.wav`: deterministic fake-mic baseline used by runner/harness flows. It stays in `demo/assets/` only and must not ship in runtime/public artifacts.
